...
public class searchBox extends TestMain {
	...
	public void search() throws NumberFormatException, InterruptedException {
		...
		driver.findElement(By.id("cli_shellHeaderSearchInput")).sendKeys("Visual Studio Professional 2026");// Sends
																											// Values
		Thread.sleep(Long.parseLong("1000"));
		List<WebElement> LIST = driver.findElements(By.cssSelector(
				"#universal-header-search-auto-suggest-ul > li:nth-child(1) > a:nth-child(1) > div:nth-child(2)"));
